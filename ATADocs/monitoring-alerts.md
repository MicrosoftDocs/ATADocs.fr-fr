---
title: Présentation des alertes de surveillance d’ATA
...
|Alerte|Description|Résolution|Severity|
|----|----|----|----|
|Le certificat du centre ATA a expiré.|Après l’expiration du certificat : la connectivité des passerelles ATA avec le centre ATA échoue. Le processus du centre ATA se bloque et toutes les fonctionnalités d’ATA sont arrêtées.|[Redéployez le centre ATA](install-ata-step1.md)|Élevée|
...
|Alerte|Description|Résolution|Severity|
|----|----|----|----|
|Le certificat de la passerelle ATA a expiré.|Il n’existe pas de connectivité de cette passerelle ATA avec le centre ATA. Aucune donnée provenant de cette passerelle ATA n'est envoyée.|[Désinstallez et réinstallez la passerelle ATA](install-ata-step3.md).|Élevée|
### <a name="domain-synchronizer-not-assigned"></a>Synchronisateur de domaine non affecté
|Alerte|Description|Résolution|Severity|
|----|----|----|----|
|Aucun synchronisateur de domaine n’est affecté aux passerelles ATA. Ce cas peut se produire si aucune passerelle ATA n’est configurée en tant que candidat synchronisateur de domaine.|Quand le domaine n’est pas synchronisé, les modifications apportées aux entités peuvent entraîner l’obsolescence ou l’absence des informations des entités dans ATA, mais elles n’impactent pas la détection.|Vérifiez qu’au moins une passerelle ATA est définie comme [synchronisateur de domaine](install-ata-step5.md).|Basse|
