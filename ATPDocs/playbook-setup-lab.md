---
title: Didacticiel d’installation du laboratoire d’alerte de sécurité Azure ATP
...
1. Une [instance Azure ATP](install-step1.md) qui est [connectée à AD](install-step2.md).
1. [Téléchargez](install-step3.md) et [installez la dernière version du capteur Azure ATP](install-step4.md) sur le contrôleur de domaine de votre labo.
...
| Nom complet    | Compte SAM |Objectif|
|--------------|------------|--------------------------------------------------------------------------------------------------|
...
1. Recherchez votre stratégie SAM sous : **stratégies \> Paramètres Windows paramètres de \> sécurité \> stratégies locales \> options de sécurité \> « accès réseau : restreindre les clients autorisés à effectuer des appels distants à Sam »**_
...
1. Ajoutez le compte de service Azure ATP à la liste des comptes approuvés pour effectuer cette action sur vos systèmes Windows modernes.
...
> [Playbook de reconnaissance Azure ATP](playbook-reconnaissance.md)
