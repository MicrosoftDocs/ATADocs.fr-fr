...
> [!NOTE]
> Les alertes de sécurité *Communications suspectes via DNS* indiquent le domaine suspecté. Les nouveaux domaines, ou les domaines récemment ajoutés qui ne sont pas encore connus ou reconnus par [!INCLUDE [Product short](includes/product-short.md)], mais qui sont connus de votre organisation ou en font partie, peuvent être fermés.
