...
- [Contrôleurs de domaine avec le service Spouleur d’impression disponible](atp-cas-isp-print-spooler.md)
- [Entités dormantes dans les groupes sensibles](atp-cas-isp-dormant-entities.md)
- [Entités exposant les informations d’identification en texte clair](atp-cas-isp-clear-text.md)
- [Utilisation de Microsoft LAPS](atp-cas-isp-laps.md)
- [Utilisation des protocoles hérités](atp-cas-isp-legacy-protocols.md)
- [Chemins de mouvement latéral les plus risqués](atp-cas-isp-riskiest-lmp.md)
- [Contrôleurs de domaine non supervisés](atp-cas-isp-unmonitored-domain-controller.md)
- [Attributs de compte non sécurisé](atp-cas-isp-unsecure-account-attributes.md)
- [Délégation Kerberos non sécurisée](atp-cas-isp-unconstrained-kerberos.md)
- [Attributs d’historique SID non sécurisés](atp-cas-isp-unsecure-sid-history-attribute.md)
- [Utilisation d’un chiffrement faible](atp-cas-isp-weak-cipher.md)
