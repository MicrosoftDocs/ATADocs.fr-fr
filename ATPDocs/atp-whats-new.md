...
- **Nouvelle fonctionnalité en préversion publique : Évaluations de la posture de sécurité des identités Azure ATP**<br>
    Azure ATP à l’aide du portail Microsoft Cloud App Security place en **préversion publique** six nouveaux rapports d’évaluation pour évaluer, examiner, corriger et améliorer la posture de sécurité de votre organisation. En savoir plus sur [l’activation](https://docs.microsoft.com/cloud-app-security/aatp-integration) et [la prise en main](atp-mcas-integration.md) des évaluations de la posture de sécurité des identités Azure ATP dans Cloud App Security et [l’utilisation](atp-ispm-overview.md) de chaque nouvelle évaluation :
    - [Entités dormantes](atp-mcas-ispm-dormant-entities.md)
    - [Texte en clair](atp-mcas-ispm-clear-text.md)
    - [Utilisation d’un chiffrement faible](atp-mcas-ispm-weak-cipher.md)
    - [Délégation Kerberos non contrainte](atp-mcas-ispm-unconstrained-kerberos.md)
    - [Spouleur d’impression](atp-mcas-ispm-print-spooler.md)
    - [Protocoles hérités](atp-mcas-ispm-legacy-protocols.md)
...
- **Amélioration de fonctionnalité : Alerte de connexion VPN suspecte**<br>
...
Des alertes de monitoring ont été ajoutées pour les niveaux de confiance associés à des alertes de sécurité Azure ATP qui reposent sur la résolution NNR. Chacune comprend des recommandations actionnables et détaillées aidant à résoudre les faibles taux de réussite NNR. 
...
- **Prise en charge serveur : ajout de Server 2019 avec KB4487044**<br>
...
- **Amélioration de fonctionnalité : Exclusion d’alertes en fonction des utilisateurs**<br>
...
- **Amélioration de fonctionnalité : Alerte de suspicion d’usurpation d’identité (pass-the-ticket)**<br> Cette alerte présente maintenant de nouvelles preuves montrant les détails des connexions établies avec le protocole Bureau à distance (RDP). La preuve ajoutée simplifie la résolution du problème connu des alertes B-TP (Begnin-True Positive) causées par l’utilisation de Credential Guard à distance sur les connexions RDP. 

- **Amélioration de fonctionnalité : Alerte d’exécution de code à distance sur DNS**<br> Cette alerte présente maintenant une nouvelle preuve montrant l’état de mise à jour de sécurité de votre contrôleur de domaine pour vous informer si des mises à jour sont requises.   

- **Nouvelle fonctionnalité de la documentation : Alerte de sécurité Azure ATP MITRE ATT&CK Matrix™**<br>
