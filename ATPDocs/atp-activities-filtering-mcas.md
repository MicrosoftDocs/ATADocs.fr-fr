...
Pour plus d’informations sur l’exécution de votre intégration, consultez [Intégration d’Azure ATP Cloud App Security](https://docs.microsoft.com/cloud-app-security/aatp-integration).
